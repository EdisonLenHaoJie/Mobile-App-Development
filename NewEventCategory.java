...
public class NewEventCategory extends AppCompatActivity {
    ...
    public void onSaveCategoryButtonClick(View view){
        ...
        saveDataToSharedPreference(CategoryIdString,CategoryNameString,CountNonNegative,isActiveBool );



        AddCategoryNavDrawer addCategoryNavDrawer= new AddCategoryNavDrawer(CategoryIdString,CategoryNameString,CountNonNegative,isActiveBool);
    ...
    private void saveDataToSharedPreference(String categoryIdValue, String catergoryNameValue , int eventCountValue, boolean isActiveBool){
